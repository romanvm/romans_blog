...
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+batch+c+csharp+cpp+ruby+go+java+lua+markdown+nim+objectivec+perl+php+powershell+python+rest+rust+swift+typescript+yaml */
...
define("tinymce/codesampleplugin/Plugin", [
	...
	PluginManager.add('codesample', function(editor, pluginUrl) {
      ...
      editor.contentCSS.push(editor.getParam('codesample_css', pluginUrl + '/css/prism.css'));
		...
		editor.on('SetContent', function() {
            ...
            if (checkLineNumbers(elm)) {
              add_line_numbers(elm);
            }
